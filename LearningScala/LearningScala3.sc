object LearningScala3 {
  ...
  def uppercaseStr(s: String): String = {
  		s.toUpperCase()
  }                                               //> uppercaseStr: (s: String)String
  
  val uppercaseStrInline = (s:String) => { s.toUpperCase() }
                                                  //> uppercaseStrInline  : String => String = LearningScala3$$$Lambda$12/1209271
                                                  //| 652@58ceff1
  uppercaseStr("hey")                             //> res3: String = HEY
  uppercaseStrInline("hey")                       //> res4: String = HEY
}