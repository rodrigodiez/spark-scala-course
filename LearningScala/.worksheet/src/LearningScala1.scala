object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(126); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(320); 
  ...
  val doubleOfPi = piSinglePrecision * 2;System.out.println("""doubleOfPi  : Float = """ + $show(doubleOfPi ));$skip(30); 
  println(f"$doubleOfPi%.3f")}
